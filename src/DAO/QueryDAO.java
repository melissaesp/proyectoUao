...
public class QueryDAO {
    ...
    /*Metodo agregar*/
    public void Agregar(almacenar atributaSave) {
        Conectar conec = new Conectar();
    ...
    /*Metodo Modificar*/
    public void Modificar(almacenar atributaSave) {
        Conectar conec = new Conectar();
    ...
    public void Modificar_Pdf(almacenar atributaSave) {
        Conectar conec = new Conectar();
    ...
    /*Metodo Eliminar*/
    public void Eliminar(almacenar atributaSave) {
        Conectar conec = new Conectar();
